class AddLanguageAndSensoryFieldsToChildDomainProfiles < ActiveRecord::Migration[8.0]
  def change
    ...
    add_column :child_domain_profiles, :supports, :json, default: [] # Array of support types
    ...
    add_column :child_domain_profiles, :sensitivity_tags, :json, default: [] # Array of sensitivity tags

    add_index :child_domain_profiles, :expressive_level
    add_index :child_domain_profiles, :receptive_level
    add_index :child_domain_profiles, :sensitivity_tags
  end
end
